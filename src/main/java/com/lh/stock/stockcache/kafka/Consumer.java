...
public class Consumer implements ApplicationContextAware {
    ...
    @Qualifier("freshGoodsBaseInfoCache")
    @Autowired
    private IFreshCache freshGoodsBaseInfoCache;
    ...
    public void consume(String msg){
        ...
        //解析消息
        KafkaMsgContext msgContext = JSONObject.parseObject(msg, KafkaMsgContext.class);
        //调用接口查询数据
